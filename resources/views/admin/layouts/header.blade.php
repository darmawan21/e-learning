...
<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
    ...
    <nav aria-label="breadcrumb">
        ...
        @elseif (request()->is('admin/kelas*'))
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Kelas</li>
        @elseif (request()->is('admin/mata-pelajaran*'))
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Mata Pelajaran</li>
        @elseif (request()->is('admin/jenis-ujian*'))
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Jenis Ujian</li>
        ...
        @elseif (request()->is('admin/pengumuman*'))
        ...
        @elseif (request()->is('admin/jenis-ujian*'))
            <h6 class="font-weight-bolder text-white mb-0">Jenis Ujian</h6>
        @elseif (request()->is('admin/guru*'))
