    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card-header pb-0">
                ...
                <a href="{{ route('admin.semester.create') }}" class="btn btn-icon btn-3 btn-primary">
                    ...
                    <tbody>
                        @foreach ($semesters as $semester)
                            <tr>
                                ...
                                <td class="align-middle text-center text-sm">{{ $semester->nama_semester }}</td>
                                <td class="align-middle text-center text-sm">
                                    <a href="{{ route('admin.semester.edit', $semester->id) }}">
                                        <i class="fas fa-pencil-alt p-3"></i>
                                    </a>
                                    <a onclick="return confirm('Apakah anda yakin hapus data ini ?')" href="{{ route('admin.semester.destroy', $semester->id) }}">
