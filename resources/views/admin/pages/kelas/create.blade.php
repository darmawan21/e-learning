        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <form method="POST" action="{{ route('admin.kelas.store') }}" enctype="multipart/form-data">
                    @csrf   
                    <div class="card-body">
                        <h6 class="text-uppercase text-sm">Form Kelas</h6>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('nama_kelas')
                                        is-invalid
                                    @enderror" id="nama_kelas" type="text" name="nama_kelas" required value="{{ old('nama_kelas') }}">
                                    @error('nama_kelas')
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="tahun_ajaran_id">
                                        @foreach ($tahunAjarans as $tahunAjaran)
                                            @if (old('tahun_ajaran_id') == $tahunAjaran->id)
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="semester_id">
                                        @foreach ($semesters as $semester)
                                            @if (old('tahun_ajaran_id') == $semester->id)
