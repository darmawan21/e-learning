    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card-header pb-0">
                ...
                <a href="{{ route('admin.kelas.create') }}" class="btn btn-icon btn-3 btn-primary">
                    <span class="btn-inner--icon"><i class="ni ni-fat-add"></i></span>
                    <span class="btn-inner--text">Tambah Kelas</span>
                </a>
                <h6>Data Kelas</h6>
            </div>
                    ...
                    @foreach ($kelas as $kls)
                            <tr>
                                ...
                                <td class="align-middle text-center text-sm">
                                    ...
                                    <a onclick="return confirm('Apakah anda yakin hapus data ini ?')" href="{{ route('admin.kelas.destroy', $kls->id) }}">
