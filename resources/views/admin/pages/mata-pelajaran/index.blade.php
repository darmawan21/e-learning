    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card-header pb-0">
                ...
                <a href="{{ route('admin.mata_pelajaran.create') }}" class="btn btn-icon btn-3 btn-primary">
                ...
                <table class="table align-items-center mb-0">
                    ...
                    @foreach ($mapels as $mapel)
                            <tr>
                                ...
                                <td class="align-middle text-center text-sm">{{ $mapel->nama_mapel }}</td>
                                <td class="align-middle text-center text-sm">
                                    <a href="{{ route('admin.mata_pelajaran.edit', $mapel->id) }}">
                                        <i class="fas fa-pencil-alt p-3"></i>
                                    </a>
                                    <a onclick="return confirm('Apakah anda yakin hapus data ini ?')" href="{{ route('admin.mata_pelajaran.destroy', $mapel->id) }}">
