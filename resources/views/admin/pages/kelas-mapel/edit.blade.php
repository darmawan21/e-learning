    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                ...
                <form method="POST" action="{{ route('admin.kelas-mapel.update', [$guru->guru_id, $guru->id]) }}" enctype="multipart/form-data">
                    @method('put')
                    @csrf   
                    <div class="card-body">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    @foreach ($mapels as $mapel)
                                        @if (old('mata_pelajaran_id', $guru->mata_pelajaran_id) == $mapel->id)
                                ...
                                <div class="form-group">
                                    ...
                                    @foreach ($kelas as $kls)
                                        @if (old('kelas_id', $guru->kelas_id) == $kls->id)
