                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('nama_materi')
                                        is-invalid
                                    @enderror" id="nama_materi" type="text" name="nama_materi" required value="{{ old('nama_materi') }}">
                                    @error('nama_materi')
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="konten" type="hidden" name="konten" required value="{{ old('konten') }}">
