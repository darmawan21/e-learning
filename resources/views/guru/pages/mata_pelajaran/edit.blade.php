    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                ...
                <form method="POST" action="{{ route('guru.mata-pelajaran.update', $kelasmapels->id) }}" enctype="multipart/form-data">
                    @method('put')
                    @csrf   
                    <div class="card-body">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    @foreach ($mapels as $mapel)
                                        @if (old('mata_pelajaran_id', $kelasmapels->mata_pelajaran_id) == $mapel->id)
                                ...
                                <div class="form-group">
                                    ...
                                    @foreach ($kelas as $kls)
                                        @if (old('kelas_id', $kelasmapels->kelas_id) == $kls->id)
