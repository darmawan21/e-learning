                            ...
                            <div class="d-flex flex-column">
                                <h6 class="mb-1 text-dark text-sm">
                                    @if ($komentar->user !=null)
                                        Siswa: {{ $komentar->user->name }} . <span class="text-xs">{{$komentar->created_at->diffForHumans() }}</span>
                                    @endif
                                    @if ($komentar->guru !=null)
                                        Guru: {{ $komentar->guru->name }} . <span class="text-xs">{{$komentar->created_at->diffForHumans() }}</span>
                                    @endif
                                </h6>
                                <p>
                                    {{$komentar->konten}}
