    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card-header pb-0">
                ...
                <a href="{{ route('guru.pengumuman.create') }}" class="btn btn-icon btn-3 btn-primary">
                        ...
                        @foreach ($pengumumans as $pengumuman)
                            <tr>
                                ...
                                <td class="align-middle text-center text-sm">
                                    <a href="{{ route('guru.pengumuman.edit', $pengumuman->id) }}">
                                        <i class="fas fa-pencil-alt p-3"></i>
                                    </a>
                                    <a onclick="return confirm('Apakah anda yakin hapus data ini ?')" href="{{ route('guru.pengumuman.destroy', $pengumuman->id) }}">
