    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                ...
                <form method="POST" action="{{ route('guru.pengumuman.store') }}" enctype="multipart/form-data">
                    @csrf   
                    <div class="card-body">
                        <h6 class="text-uppercase text-sm">Form Pengumuman</h6>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('pengumuman')
                                        is-invalid
                                    @enderror" id="pengumuman" type="text" name="pengumuman" required value="{{ old('pengumuman') }}">
                                    @error('pengumuman')
