                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name="oldImage" value="{{ $soals->image }}">
                                    @if ($soals->image)
                                        <img src="{{ asset('storage/' . $soals->image ) }}" class="img-preview img-fluid mb-3 col-sm-5 d-block">
                                    @else
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <option @if (old('kunci', $soals->kunci) === 'pilihan1')
                                    selected
                                @endif value="pilihan1">A</option>
                                <option @if (old('kunci', $soals->kunci) === 'pilihan2')
                                    selected
                                @endif value="pilihan2">B</option>
                                <option @if (old('kunci', $soals->kunci) === 'pilihan3')
                                    selected
                                @endif value="pilihan3">C</option>
                                <option @if (old('kunci', $soals->kunci) === 'pilihan4')
                                    selected
